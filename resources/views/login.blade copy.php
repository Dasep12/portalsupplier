                        ...
                        <div class="row">
                                ...
                                <div class="form-left h-100 py-5 px-5">
                                    <form id="formLogin" data-parsley-validate method="post" action="" class="row g-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <button id="" type="submit" class="btn btn-sm btn-primary px-4 float-end mt-4"><i class="fa fa-paper-plane"></i> LOGIN PORTAL</button>
                                        </div>
                            ...
                            <div class="col-md-4 ps-0  d-none d-md-block">
                                ...
                                <div class="form-right h-100 text-center pt-5">
                                    ...
                                    <label style="font-weight: 600;font-style: italic;color: #fff;font-size: 13px;" for=""> 1.0</label>
                                </div>
                            </div>
                        </div>
                    </div>
